...
def generate_launch_description():
    ...
    siwr_launch_file_dir = os.path.join(get_package_share_directory('projekt_siwr'), '')
    ...
    rviz_config_file = '/home/rosdev/ros2_ws/src/projekt_siwr/config/rviz_config.rviz'
